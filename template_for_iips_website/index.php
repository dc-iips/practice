	...
	<div class="container">
				...
				<div class="col-md-6">
					<div id="owl-demo" class="owl-carousel text-center">	
						...
						<div class="item">
							...
							<div class="cau_left">
								<h4><a href="#">Aishwarya Halve</a></h4>
								<p>
									Placed: Infosys
									Pkg: 4 pa	
								</p>
				...
				<div class="col-md-3" style="padding-top:20px;">
					<div class="panel panel-default" style="border-radius:0px;">
  						...
  						<div class="panel-body">
    						New Session will start from 20th October<br>
    						Panel Content<br>
  						</div>
					</div>
				</div>
...
<div>
<div class="main_bg" style="background-color:#F6F6F6;font-size:14px;"><!-- start main -->
	<div class="container">
		<div class="col-md-2">
			<label class="red">Admissions</a>
			<br>
			<a href="">CET</a><br>
			<a href="">Eligibility</a><br>
			<a href="">Counselling</a><br>
			<a href="">Apply</a><br>
			<a href="">Fees Structure</a><br>			
		</div>
		<div class="col-md-2">
			<label class="red">Downloads</a>
			<br>
			<a href="">Academics</a><br>
			<a href="">Calendar</a><br>
			<a href="">Syllabus</a><br>
			<a href="">Formats</a><br>
			<a href="">Miscelleanous</a><br>
		</div>
